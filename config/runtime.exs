...
#
#     PHX_SERVER=true bin/crypto_stream start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :crypto_stream, CryptoStreamWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :crypto_stream, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :crypto_stream, CryptoStream.Mailer,
